...
const AddProduct = () => {
    ...
    return (
      ...
      <div className="form-control">
        ...
        <input type="text" name='buyingPrice' placeholder="price" className="input input-bordered" required/>
      </div>
        <div className="form-control ">
        <label className="label">
          <span className="label-text">Selling Price</span>
        </label>
        <input type="text" name='sellingPrice' placeholder="price" className="input input-bordered" required/>
      </div>
        <div className="form-control ">
        <label className="label">
          <span className="label-text">Phone Number</span>
        </label>
        <input type="text" name='phoneNumber' placeholder="number" className="input input-bordered" required/>
      </div>
        <div className="form-control ">
        <label className="label">
        ...
        <input type="text" name='condition' placeholder="Ex: excellent, good, fair" className="input input-bordered" required/>
      </div>
      <div className="form-control">
        <label className="label">
          <span className="label-text">Category</span>
        </label>
        <input type="text" name='category' placeholder="Ex: samsung, beko, LG" className="input input-bordered" required/>
      ...
      <div className="form-control">
        ...
        <input type="text" name='published_date' placeholder="Ex: 01-01-2000" className="input input-bordered" required/>
